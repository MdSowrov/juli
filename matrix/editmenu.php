...
if(isset($_REQUEST['id'])){
    $id = $_REQUEST['id'];
    if ($obj->getById("menus", "*", "menu_id=$id")!=false) {
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="editmenu.php" method="post">
                                <div class="card-body">
...
if(isset($_REQUEST['submit'])){
    extract($_REQUEST);
$sowrov = $obj->Update("menus", "name='$name', content='$content', status='$status'", "menu_id=$edit_id");    
if($sowrov == true){  ?>
    <!-- $msg = "Insert Menu"; -->
