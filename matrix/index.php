...
if($obj->getById("users", "*", "username='$username' && password='$password' && status='active'")!=false){
    $userinfo = $obj->getById("users", "*", "username='$username' && password='$password' && status='active'");
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <a href="register.php"><button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Register</button></a>
